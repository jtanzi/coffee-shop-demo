...
export const MENU: MenuItem[] = [
  ...
  { name: 'Iced Matcha', type: 'cold beverage', sizes: ['s', 'm', 'l'], prices: ["2.10", "2.60", "2.80"] },
  { name: 'Strawberry Lemonade', type: 'cold beverage', sizes: ['s', 'm', 'l'], prices: ["2.10", "2.60", "2.80"] },
  ...
  { name: 'Lemon & Sage Scone', type: 'pastry', sizes: [], prices: ["4.10"] },
  { name: 'Strawberry & Cheese Croissant', type: 'pastry', sizes: [], prices: ["4.10"] },
  { name: 'Cinnamon Roll', type: 'pastry', sizes: [], prices: ["4.10"] }, 
];
